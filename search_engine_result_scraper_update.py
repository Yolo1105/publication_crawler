...
def fetch_google_search_results(query, num_pages=3, valid_proxies=None, start_page=0):
    results_data = []
...
def main():
    ...
    results_data.extend(fetch_google_search_results(query, num_pages, start_page=start_page))
    if results_data:
